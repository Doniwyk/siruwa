            ...
            <tr>
                <td>
                    <div class="flex gap-5 text-main">
                        <img src="{{ asset('assets/img/news-img.png') }}" alt="">
                        <p class="desc-news">
                            Politeknik Negeri Malang terjerat kasus dugaan korupsi pengadaan tanah senilai 40M, dua dir...
                        </p>
                    </div>
                </td>
                <td>
                        ...
                        <div class="details">
                            <svg width="16" height="17" viewBox="0 0 16 17" fill="none"
                                ...
                                <path
                                    ...
                                    stroke="#225157" stroke-width="1.2" stroke-miterlimit="10" stroke-linecap="round"
                                    stroke-linejoin="round" />
                                <path d="M10.6934 6.68474C11.0602 6.50132 11.4552 6.40256 11.8644 6.39551" stroke="#225157"
