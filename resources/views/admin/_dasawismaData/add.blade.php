...
@section('content')
    ...
    <main>
        <form action="" class="bg-white py-9 px-24 rounded-2xl flex flex-col gap-9">
            ...
            <section class="flex justify-end gap-x-6">
                <button type="button" onclick="window.location='{{ route('admin.data-penduduk.index') }}'" class="py-3 px-10 w-60 font-semibold text-main rounded-2xl border-2 border-main">Batalkan</button>
