...
@section('content')
    ...
    <div class="p-8 bg-white flex flex-col ">
        ...
        <form action="" class="user-information bg-white flex flex-col gap-5">
            ...
            <div class="wrapper grid grid-rows-2 grid-cols-2 gap-x-9 gap-y-5">
                <x-shared.input :label="'Kata Sandi Lama'" :type="'password'" :name="'old-password'" :id="'old-password'"
                    :placeholder="'Kata Sandi Lama'" />
                <x-shared.input :label="'Kata Sandi Baru'" :type="'password'" :name="'new-password'" :id="'new-password'"
                    :placeholder="'Kata Sandi Baru'" />
                <x-shared.input :label="'Konfirmasi Kata Sandi Baru'" :type="'password'" :name="'confirm-password'" :id="'confirm-password'"
