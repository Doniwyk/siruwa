<div class="add-news flex justify-end button-hover">
    <a href="{{ $route }}">
    <button class="h-[3rem] sm:w-[3rem] lg:w-[15rem] bg-main text-white  rounded-2xl flex-center gap-3">
        ...
        <label for="" class="sm:hidden lg:block">Buat Berita</label>
    </button>
    </a>
</div>
