        ...
        <div class="filter flex-center">
            <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path
                    ...
                    stroke="#97A7A8" stroke-width="2" stroke-miterlimit="10" stroke-linecap="round"
                    stroke-linejoin="round" />
                <path d="M9.10833 1.75L5 8.33333" stroke="#97A7A8" stroke-width="2" stroke-miterlimit="10"
                    stroke-linecap="round" stroke-linejoin="round" />
            </svg>
            <label for="" class="ml-3 flex-center text-sm sm:hidden lg:block font-semibold text-main">Urutkan</label>
        </div>
        <button name="order" id="order-select" value="{{ $order }}" class="transition-all ease-linear">
            <svg width="22" height="24" viewBox="0 0 22 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path
                    d="M12.3837 15.2002L14.1896 13.2302L17.1321 10.0202C17.7462 9.34018 17.3062 8.18018 16.4262 8.18018L10.7154 8.18018L5.57291 8.18018C4.69291 8.18018 4.25291 9.34018 4.87625 10.0202L9.62458 15.2002C10.3762 16.0302 11.6229 16.0302 12.3837 15.2002Z"
                    fill="#97A7A8" />
            </svg>
        </button>
    </div>
