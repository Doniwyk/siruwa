...
<body>
    <div id="root" class="h-screen flex flex-col">
        ...
        <main class="grow flex">
            @yield('modal')
            @yield('modal_riwayat')
            <section class="absolute min-h-full min-w-full flex items-center justify-center bg-black/50 z-50" id="loader-modal_parent">
                <div role="status">
                    <svg aria-hidden="true" class="w-16 h-16 text-gray-200 animate-spin dark:text-gray-600 fill-secondary" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
